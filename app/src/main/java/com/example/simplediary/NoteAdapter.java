...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.ViewHolder> implements OnNoteItemClickListener{
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        ImageView moodeImageview;
        ImageView moodeImageView2;
        ...
        public ViewHolder(@NonNull View itemView, final OnNoteItemClickListener listener, int layoutType) {
            ...
            moodeImageview = itemView.findViewById(R.id.moodImageView);
            moodeImageView2 = itemView.findViewById(R.id.moodImageView2);
        ...
        public void setItem(Note item){
            ...
            dateTextView.setText(item.getCreateDataeStr());
            dateTextView2.setText(item.getCreateDataeStr());
        }

        public void setMoodImage(int moodIndex){
            switch (moodIndex){
                case 0:
                    moodeImageview.setImageResource(R.drawable.smile1_48);
                    moodeImageView2.setImageResource(R.drawable.smile1_48);
                    break;
                case 1:
                    moodeImageview.setImageResource(R.drawable.smile2_48);
                    moodeImageView2.setImageResource(R.drawable.smile2_48);
                    break;
                case 2:
                    moodeImageview.setImageResource(R.drawable.smile3_48);
                    moodeImageView2.setImageResource(R.drawable.smile3_48);
                    break;
                case 3:
                    moodeImageview.setImageResource(R.drawable.smile4_48);
                    moodeImageView2.setImageResource(R.drawable.smile4_48);
                    break;
                case 4:
                    moodeImageview.setImageResource(R.drawable.smile5_48);
                    moodeImageView2.setImageResource(R.drawable.smile5_48);
                    break;
                default:
                    moodeImageview.setImageResource(R.drawable.smile3_48);
                    moodeImageView2.setImageResource(R.drawable.smile3_48);
